        ...
        egui::TopBottomPanel::bottom("mixer").show_animated(ctx, self.show_mixer, |ui| {
            ui.with_layout(egui::Layout::left_to_right(egui::Align::Center), |ui| {
                ...
                ui.add(egui::Slider::new(&mut self.mixer.downbeat, 0.0..=1.0)
                    ...
                    .text("Downbeat"));
                ui.add(egui::Slider::new(&mut self.mixer.primary, 0.0..=1.0)
                    .orientation(SliderOrientation::Vertical)
                    .handle_shape(HandleShape::Rect { aspect_ratio: 1.5 })
                    .custom_formatter(formatter)
                    .text("Primary Beat"));
                ui.add(egui::Slider::new(&mut self.mixer.accent, 0.0..=1.0)
                    .orientation(SliderOrientation::Vertical)
                    .handle_shape(HandleShape::Rect { aspect_ratio: 1.5 })
                    .custom_formatter(formatter)
                    .text("Accented Beat"));
                ui.add(egui::Slider::new(&mut self.mixer.beat, 0.0..=1.0)
                    .orientation(SliderOrientation::Vertical)
                    .handle_shape(HandleShape::Rect { aspect_ratio: 1.5 })
                    .custom_formatter(formatter)
                    .text("Beat"));
