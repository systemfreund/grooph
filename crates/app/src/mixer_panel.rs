            ...
            egui::ScrollArea::horizontal()
                ...
                .show(ui, |ui| {
                    ui.with_layout(egui::Layout::left_to_right(egui::Align::Center), |ui| {
                        ...
                        ui.add(
                            egui::Slider::new(
                                &mut self.playback_ctl.audio_cfg.settings.downbeat,
                                0.0..=1.0,
                            )
                        ...
                        ui.add(
                            egui::Slider::new(
                                &mut self.playback_ctl.audio_cfg.settings.primary,
                                0.0..=1.0,
                            )
                            .orientation(SliderOrientation::Vertical)
                            .handle_shape(HandleShape::Rect { aspect_ratio: 1.5 })
                        ...
                        ui.add(
                            egui::Slider::new(
                                &mut self.playback_ctl.audio_cfg.settings.accent,
                                0.0..=1.0,
                            )
                            .orientation(SliderOrientation::Vertical)
                            .handle_shape(HandleShape::Rect { aspect_ratio: 1.5 })
                        ...
                        ui.add(
                            egui::Slider::new(
                                &mut self.playback_ctl.audio_cfg.settings.beat,
                                0.0..=1.0,
                            )
                            .orientation(SliderOrientation::Vertical)
                            .handle_shape(HandleShape::Rect { aspect_ratio: 1.5 })
