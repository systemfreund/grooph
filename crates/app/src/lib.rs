...
pub struct Grooph {
    ...
    accuracy_last_hit: Option<AccuracyHit>,
...
impl Grooph {
    ...
    fn record_accuracy_hit(
        ...
        if let Some((beat_idx, diff_ticks)) = best {
            ...
            self.accuracy_last_hit = Some(AccuracyHit { beat_idx, delta_ticks: diff_ticks });
        }
    }
